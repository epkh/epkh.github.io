...
function loadpage(error, pa_pumas_05_mid, counties16) {
    ...
    var Rmymap = Rmapcontainer.append("svg")
        ...
        .style("fill", function(d) { 
            console.log("fill" + d.properties.r05_50);
            if (d.properties.r05_50 > 0) {
              return d3.interpolateOrRd(d.properties.r05_50/100);
        ...
        .on("mouseover", function(d){
          console.log("mouseover"+ d.properties.r05_50);
        return Rtooltip.style("visibility", "visible").text("% Burdened at 50%:" + Math.round(d.properties.r05_50) +"%");
        })
        .on("mousemove", function(d){
          console.log("mousemove");
        return Rtooltip.style("top", (event.pageY-10)+"px").style("left",(event.pageX+10)+"px").text(Math.round(d.properties.r05_50) +"%");
        })
    ...
    var Hmymap = Hmapcontainer.append("svg")
      ...
      .style("fill", function(d) { 
          ...
          return d3.interpolateGnBu((d.properties.h05_50/100)*2);
          } else {
          return "white";
          };
      }) 
        .on("mouseover", function(d){
        return Htooltip.style("visibility", "visible").text("% Burdened at 50%:" + Math.round(d.properties.h05_50) +"%");
        })
        .on("mousemove", function(d){
        return Htooltip.style("top", (event.pageY-10)+"px").style("left",(event.pageX+10)+"px").text(Math.round(d.properties.h05_50) +"%");
        })
        .on("mouseout", function(d){
...
function update2010(error, pa_pumas_05_mid, counties16) { // initial creation
    ...
    var Rmymap = Rmapcontainer.select("svg")
        ...
        .style("fill", function(d) { 
            ...
            return d3.interpolateOrRd(d.properties.r10_50/100);
            } else {
            return "#FFF";
            }; 
        })
        .on("mouseover", function(d){
          console.log("mouseover"+ d.properties.r10_50);
        return Rtooltip.style("visibility", "visible").text("% Burdened at 50%:" + Math.round(d.properties.r10_50) +"%");
        })
        .on("mousemove", function(d){
          console.log("mousemove");
        return Rtooltip.style("top", (event.pageY-10)+"px").style("left",(event.pageX+10)+"px").text(Math.round(d.properties.r10_50) +"%");
        })
        .on("mouseout", function(d){
          return Rtooltip.style("visibility", "hidden");
        });
    ...
    var Hmymap = Hmapcontainer.select("svg")
      ...
      .style("fill", function(d) { 
          ...
          return d3.interpolateGnBu((d.properties.h10_50/100)*2);
          } else {
          return "#FFF";
          };
      })
      .on("mouseover", function(d){
        console.log("mouseover"+ d.properties.h10_50);
        return Rtooltip.style("visibility", "visible").text("% Burdened at 50%:" + Math.round(d.properties.h10_50) +"%");
        })
      .on("mousemove", function(d){
        console.log("mousemove");
        return Rtooltip.style("top", (event.pageY-10)+"px").style("left",(event.pageX+10)+"px").text(Math.round(d.properties.h10_50) +"%");
        })
      .on("mouseout", function(d){
        return Rtooltip.style("visibility", "hidden");
        });
...
function update2005(error, pa_pumas_05_mid, counties16) { // initial creation
    ...
    d3.select("#mapHbur").select("svg")
      ...
      .on("mouseover", function(d){
        console.log("mouseover"+ d.properties.h05_50);
        return Rtooltip.style("visibility", "visible").text("% Burdened at 50%:" + Math.round(d.properties.h05_50) +"%");
        })
      .on("mousemove", function(d){
        console.log("mousemove");
        return Rtooltip.style("top", (event.pageY-10)+"px").style("left",(event.pageX+10)+"px").text(Math.round(d.properties.h05_50) +"%");
        })
      .on("mouseout", function(d){
        return Rtooltip.style("visibility", "hidden");
      });
...
function update2015(error, pa_pumas_16_mid_clip, counties16) { // initial creation
    ...
    d3.select("#mapRbur").select("svg")
        ...
        .style("fill", function(d) { 
            ...
            return d3.interpolateOrRd(d.properties.r15_50/100);
            } else {
            return "#FFF";
          };  
        })
        .on("mouseover", function(d){
          console.log("mouseover"+ d.properties.r15_50);
        return Rtooltip.style("visibility", "visible").text("% Burdened at 50%:" + Math.round(d.properties.r15_50) +"%");
        })
        .on("mousemove", function(d){
          console.log("mousemove");
        return Rtooltip.style("top", (event.pageY-10)+"px").style("left",(event.pageX+10)+"px").text(Math.round(d.properties.r15_50) +"%");
        })
        .on("mouseout", function(d){
        return Rtooltip.style("visibility", "hidden");
        });
    ...
    d3.select("#mapHbur").select("svg")
      ...
      .style("fill", function(d) { 
          ...
          return d3.interpolateGnBu((d.properties.h15_50/100)*2);
          } else {
          return "#FFF";
          }; 
      })
      .on("mouseover", function(d){
        console.log("mouseover"+ d.properties.h15_50);
        return Rtooltip.style("visibility", "visible").text("% Burdened at 50%:" + Math.round(d.properties.h15_50) +"%");
        })
      .on("mousemove", function(d){
        console.log("mousemove");
        return Rtooltip.style("top", (event.pageY-10)+"px").style("left",(event.pageX+10)+"px").text(Math.round(d.properties.h15_50) +"%");
        })
      .on("mouseout", function(d){
        return Rtooltip.style("visibility", "hidden");
        });
